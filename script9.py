...
Null,userprof = subprocess.check_ouput('set USERPROFILE',shell=True,stdin=subprocess.PIPE,stderr=subprocess.PIPE).decode().split('=')
destination = userprof.strip('\n\r') + "\\Documents\\" + 'Target.exe'

if not os.path.exists(destination):
    shutil.copyfile(path+'\Target.exe',destination)
